...
# Gov.uk search api
gov_search <- function(search_term='"workforce management information"',date_range=NULL) {
  if (is.null(date_range)) date_range <- paste0("from:",format(Sys.Date()-366,"%Y-%m-%d")) # search last year by default
